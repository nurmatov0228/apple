    ...
    return (
      <section className="about" id="about">
        <div className="container">
          ...
          >
            <h2 className="about_title2">Business Strategy</h2>
          </div>
          <div className="about_flex">
            ...
            >
              <div className="about_cards">
                ...
                <h3 className="about_card_title">Revenue model</h3>
                <p className="about_card_text">
                 Apple earns money by selling products like iPhones, MacBooks, iPads, and 
                 accessories. The company also makes money from services such as Apple Music,
                  iCloud, and the App Store. These services bring regular income through subscriptions.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className="about_cards">
                ...
                <h3 className="about_card_title">Strategy</h3>
                <p className="about_card_text">
                  Apple focuses on high quality, modern design, and user-friendly products.
                   The company creates an ecosystem where all devices work together smoothly.
                    This makes customers stay with Apple products for a long time. Apple also
                     invests in innovation and new technology.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className="about_cards cc">
                ...
                <h3 className="about_card_title">Strengths</h3>
                <p className="about_card_text">
                 One of the main strengths is Apple’s strong brand and loyal customers.
                  The company is known for its premium quality and reliability. Another
                   strength is its unique design and simple interface. Apple also has excellent
                    marketing, which helps attract many users around the world.{" "}
                </p>
              </div>
            </div>
          </div>
